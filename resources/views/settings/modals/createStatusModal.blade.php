<form method="post" action="{{ route('status.store') }}" enctype="multipart/form-data"
    id="createStatus">
    @csrf
    <div class="modal fade" id="createStatusModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="text-start" for="abreviation">Abreviation:</label>
                    <div class="form-container m-0 p-0">
                        <input type="text" class="input text-dark" name="abreviation" id="abreviation"
                            placeholder="abreviation" value="{{ old('abreviation') }}" required>
                    </div>
                </div>
